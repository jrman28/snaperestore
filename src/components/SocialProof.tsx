...
import { Star, Users, Image, Trophy } from 'lucide-react';
...
const SocialProof = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      content: "I've tried many restoration tools, but nothing comes close to SnapRestore. The AI is incredibly smart and the results are professional-grade.",
      rating: 5
    },
    {
      name: "Emma Thompson",
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-lg text-gray-600 mb-12">
            Join our growing community of satisfied users who've restored their precious memories
          </p>
            ...
            {stats.map((stat, index) => {
              ...
              return (
                <div key={index} className="text-center">
                  <div className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-white shadow-soft mb-4 ${stat.color}`}>
                    <Icon size={24} />
                  </div>
