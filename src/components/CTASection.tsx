      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl text-purple-100 mb-8 leading-relaxed max-w-2xl mx-auto">
            ...
            Start your restoration journey today—it's quick, easy, and magical.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button
              ...
              size="lg"
              className="bg-white text-purple-700 hover:bg-gray-50 px-8 py-4 text-lg font-semibold shadow-soft-lg hover:shadow-soft-xl transform hover:scale-105 transition-all duration-300 touch-target"
            >
          ...
          <div className="mt-12 pt-8 border-t border-purple-400/30">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
              <div className="text-purple-100">
                ...
                <div className="text-sm">Average restoration time</div>
              </div>
              <div className="text-purple-100">
